...
public class ZeusVRPBGui
   ...
   */
    //here
  public ZeusVRPBGui(DepotLinkedList mD, ShipmentLinkedList mS , double lineHaulTotal, double backhaulTotal) {
    //run the JFrame constructor
    //super("Zeus - Unified Model for Vehicle Routing Problems");
   ...
   * @param info String
   */
  public ZeusVRPBGui(DepotLinkedList mD, ShipmentLinkedList mS, double[] SFC, String info) {
    //run the JFrame constructor
    super("Zeus - Unified Model for Vehicle Routing Problems");
  ...
  private void jbInit(double lineHaulTotal, double backHaulTotal) throws Exception {
	    ...
	    desktop.add(shipmentFrame);
	      ...
	      //create the info frame and place it in the display
	      infoFrame = new InfoFrame(ZeusGuiInfo.mainDepots.getSolutionString(),lineHaulTotal,backHaulTotal);
	      infoFrame.setVisible(ZeusGuiInfo.showInfoPane);
	      infoFrame.setBounds(this.getWidth() - infoFrame.getWidth(), 0,
	                          infoFrame.getWidth(), infoFrame.getHeight());
	      desktop.add(infoFrame);
