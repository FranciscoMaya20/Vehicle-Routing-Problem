...
import edu.sru.group1.zeus.vrpb.VRPBNodesLinkedList;
//import edu.sru.group1.zeus.vrpb.VRPBNodes;

public class VRPBNodesLLCostFunctions extends VRPBAbstractCostFunctions implements java.io.Serializable
{
	...
	public void setTotalDemand(Object o) {
		...
		while (tempCell != vNodes.getTail()) {
			String custType = tempCell.getShipment().getCustomerType();
