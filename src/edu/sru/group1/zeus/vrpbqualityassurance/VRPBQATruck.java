...
public class VRPBQATruck extends QATruck implements java.io.Serializable, java.lang.Cloneable
{
	public VRPBQATruck() {
	  }

	  public boolean checkDistanceConstraint(VRPBQATruck truck) {
		  boolean isDiagnostic = true;
		    ...
		    if (isDiagnostic) {
		      ...
		      for (int i = 0; i < getNodes().size(); i++) {
		        node1 = (VRPBQANode) getNodes().elementAt(i);
	  ...
	  public boolean checkCapacityConstraint(VRPBQATruck truck) {
	    boolean isDiagnostic = true;
	    boolean status = true;
	    ...
	    if (isDiagnostic) {
	      ...
	      System.out.println("Sequence of the route is:");
	      for (int i = 0; i < getNodes().size(); i++) {
	        node = (VRPBQANode) getNodes().elementAt(i);
