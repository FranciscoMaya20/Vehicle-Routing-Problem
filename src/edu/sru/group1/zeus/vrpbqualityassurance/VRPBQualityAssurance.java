...
public class VRPBQualityAssurance
extends QualityAssurance {
	VRPBDepotLinkedList mainDepots;
	VRPBShipmentLinkedList mainShipments;
	VRPBQADepotLinkedList vrpbQADepots;
	VRPBQAShipmentLinkedList vrpbQAShipments;

	File shipFile;
	File solFile;

	public VRPBQualityAssurance() {
	}

	public VRPBQualityAssurance(VRPBDepotLinkedList md, VRPBShipmentLinkedList ms) {
		//used for writing out the files
		mainDepots = md;
		mainShipments = ms;
		//used for reading in the information
		vrpbQAShipments = new VRPBQAShipmentLinkedList();
		vrpbQADepots = new VRPBQADepotLinkedList();
	...
	public void readShipmentFile() {
		...
		try {
			...
			for (int i = 0; i < numships; i++) {
				...
				VRPBQAShipment s = new VRPBQAShipment();
