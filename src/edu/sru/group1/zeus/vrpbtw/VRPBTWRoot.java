...
import edu.sru.group1.zeus.vrpbtw.vrpbtwcostfunctions.*;
/**
*
* <p>VRPBRoot:</p>
* <p>Description: </p>
...
* @version 1.0
*/
public class VRPBTWRoot 
{

	public VRPBTWRoot()
	{
		ZeusProblemInfo.setNodesLLLevelCostF(new VRPBTWNodesLLCostFunctions());
		 ZeusProblemInfo.setTruckLevelCostF(new VRPBTWTruckCostFunctions());
		ZeusProblemInfo.setTruckLLLevelCostF(new VRPBTWTruckLLCostFunctions());
		ZeusProblemInfo.setDepotLevelCostF(new VRPBTWDepotCostFunctions());
		 ZeusProblemInfo.setDepotLLLevelCostF(new VRPBTWDepotLLCostFunctions());

		ZeusProblemInfo.setTempFileLocation("\\temp");
		ZeusProblemInfo.setInputPath("\\data\\VRPBTW\\Problems\\VRPBTW Data Excel\\");
		ZeusProblemInfo.setOutputPath("\\data\\VRPBTW\\Results\\");

		String fileName = "";
		
		String[] heuristicsArray = {"Polar"};//array to hold the heuristics to run all of the heuristics
